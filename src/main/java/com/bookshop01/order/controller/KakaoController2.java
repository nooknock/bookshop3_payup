...
public class KakaoController2 {
	...
	@RequestMapping(value = "/test/kakaoPay.do") //포스트 방식 지우고 responseCode 바꿔서  /test/kakaoPay.do 주소창에서 직접 들어가면 실패창 띄우기 가능 
	public ModelAndView kakaoPay(@RequestParam Map<String, String> map) throws Exception {
		...
		url="https://api.testpayup.co.kr/ep/api/kakao/"+merchantId+"/pay";
...
////		resultMap.put("type","카카오페이머니");
//		resultMap.put("type","카카오페이신용카드");
...
//		resultMap.put("fail","잘못된 접근입니다.");
		...
		System.out.println("카카오페이 승인 응답 데이터 = "+resultMap.toString());
