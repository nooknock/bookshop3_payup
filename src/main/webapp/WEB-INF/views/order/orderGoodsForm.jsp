...
//	 					jsf__pay() 함수를 호출
	...
	function fn_process_pay_order() {
		...
		if((cardNo==""||cardNo==null)||(expireMonth==""||expireMonth==null)||(expireYear==""||expireYear==null)||(birthday==""||birthday==null)||(cardPw==""||cardPw==null)){
			alert("카드정보를 입력하세요.");
		}
		...
		formObj.appendChild(document.getElementById("cardPw"));//input박스를 생성하겠다라는 의미
					...
					<table>
						<tbody align=left>
							...
							<tr>
								...
								<td><input id="expireMonth" name="expireMonth" type="text"></td>
							</tr>
							<tr>
								<td width=200px>유효기간 년 :</td>
								<td><input id="expireYear" name="expireYear" type="text"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input id="cardPw" name="cardPw" type="text"></td>
							</tr>
							<tr>
